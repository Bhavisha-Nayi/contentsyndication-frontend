...
const HeroSection = () => {
  return (
    <section className="relative pt-32 lg:pt-36 mt-20">
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <div className="relative flex flex-col lg:text-left lg:py-7 xl:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          <div>
          ...
          <div className="mt-10 w-full flex max-w-[730px] mx-auto">
              <Button
                variant="primary"
                className="min-w-max text-white mx-auto"
              >
